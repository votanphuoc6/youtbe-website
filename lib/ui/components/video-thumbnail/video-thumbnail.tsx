...
export default function VideoThumbnail(props: Props) {
    ...
    const imageUrl = props.searchItem?.snippet?.thumbnails?.high?.url || '/default-thumbnail.jpg';
    ...
    const defaultImage = "/images/default-thumbnail.jpeg";

    // Kiểm tra nếu không có imageUrl thì sử dụng ảnh mặc định
    const displayImage = defaultImage || defaultImage;
    return (
        <Fragment>
            <div className={styles.videoThumbnailHost}>
                <div className={thumbnailClasses}>
                    <div className={styles.thumbnail__image}>
                        ...
                        <Image
                        className={styles.thumbnail__image__img}
                            src={defaultImage} // Hình ảnh thumbnail hoặc hình ảnh mặc định
                            alt="Video image"
                            fill
                    ...
                    <div className={styles.thumbnailDetails}>
                        ...
                        <div className={styles.thumbnailDetailsContent}>
                            ...
                            <p className={`${styles.thumbnailDetailsContent__footer} mat-h5`}>
                                {viewCount && (
                                    <span>{ytdAbbreviateNumber(viewCount)} views •</span>
                                )}
